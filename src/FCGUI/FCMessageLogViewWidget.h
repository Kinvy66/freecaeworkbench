...
namespace FC 
{
class FCMessageLogsModel;
class FCMessageLogsSortFilterProxyModel;
...
private:
    ...
    FCMessageLogsModel* _model;
    FCMessageLogsSortFilterProxyModel* _sortFilterModel;
    QAction* _actionMessageLogShowInfo;
    QAction* _actionMessageLogShowWarning;
    QAction* _actionMessageLogShowCritical;
    QAction* _actionMessageLogShowDebug;    
