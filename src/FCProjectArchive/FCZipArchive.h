 ...
 */
#ifndef FCZIPARCHIVE_H
#define FCZIPARCHIVE_H
...
namespace FC 
{
class FCPROJECTARCHIVE_API FCZipArchive : public FCAbstractArchive
{
    Q_OBJECT
    FC_DECLARE_PRIVATE(FCZipArchive)
public:
    FCZipArchive(QObject* par = nullptr);
    FCZipArchive(const QString& zipPath, QObject* par = nullptr);
    ~FCZipArchive();
    // 设置zip文件名
