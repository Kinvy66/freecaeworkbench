#ifndef FC_ORDER_SMALL_MAP_H
#define FC_ORDER_SMALL_MAP_H
#include <qglobal.h>
#include <vector>
#include <memory>
...
public:
	...
	typedef fc_order_small_map< KEY, VALUE, CONTAINTER_KEY, CONTAINTER_VALUE > _Myt;  ///< 学stl
	...
	class iterator
	{
		...
		friend class fc_order_small_map< KEY, VALUE, CONTAINTER_KEY, CONTAINTER_VALUE >;
...
fc_order_small_map< KEY, VALUE, CONTAINTER_KEY, CONTAINTER_VALUE >::fc_order_small_map()
{
}
...
template< typename KEY, typename VALUE, typename CONTAINTER_KEY, typename CONTAINTER_VALUE >
void fc_order_small_map< KEY, VALUE, CONTAINTER_KEY, CONTAINTER_VALUE >::clear()
{
	mKeys.clear();
	mValues.clear();
}
...
template< typename KEY, typename VALUE, typename CONTAINTER_KEY, typename CONTAINTER_VALUE >
bool fc_order_small_map< KEY, VALUE, CONTAINTER_KEY, CONTAINTER_VALUE >::contains(const KEY& key) const
{
	return (mKeys.contains(key));
}

template< typename KEY, typename VALUE, typename CONTAINTER_KEY, typename CONTAINTER_VALUE >
int fc_order_small_map< KEY, VALUE, CONTAINTER_KEY, CONTAINTER_VALUE >::count(const KEY& key) const
{
	return (mKeys.count(key));
}

template< typename KEY, typename VALUE, typename CONTAINTER_KEY, typename CONTAINTER_VALUE >
int fc_order_small_map< KEY, VALUE, CONTAINTER_KEY, CONTAINTER_VALUE >::count() const
{
	return (size());
}

template< typename KEY, typename VALUE, typename CONTAINTER_KEY, typename CONTAINTER_VALUE >
bool fc_order_small_map< KEY, VALUE, CONTAINTER_KEY, CONTAINTER_VALUE >::empty() const
{
	return (mKeys.empty());
}

template< typename KEY, typename VALUE, typename CONTAINTER_KEY, typename CONTAINTER_VALUE >
VALUE& fc_order_small_map< KEY, VALUE, CONTAINTER_KEY, CONTAINTER_VALUE >::first()
{
	return (mValues.first());
}

template< typename KEY, typename VALUE, typename CONTAINTER_KEY, typename CONTAINTER_VALUE >
const VALUE& fc_order_small_map< KEY, VALUE, CONTAINTER_KEY, CONTAINTER_VALUE >::first() const
{
	return (mValues.first());
}

template< typename KEY, typename VALUE, typename CONTAINTER_KEY, typename CONTAINTER_VALUE >
const KEY& fc_order_small_map< KEY, VALUE, CONTAINTER_KEY, CONTAINTER_VALUE >::firstKey() const
{
	return (mKeys.firstKey());
}

template< typename KEY, typename VALUE, typename CONTAINTER_KEY, typename CONTAINTER_VALUE >
bool fc_order_small_map< KEY, VALUE, CONTAINTER_KEY, CONTAINTER_VALUE >::isEmpty() const
{
	return (mKeys.isEmpty());
}

template< typename KEY, typename VALUE, typename CONTAINTER_KEY, typename CONTAINTER_VALUE >
int fc_order_small_map< KEY, VALUE, CONTAINTER_KEY, CONTAINTER_VALUE >::size() const
{
	return (mKeys.size());
}

template< typename KEY, typename VALUE, typename CONTAINTER_KEY, typename CONTAINTER_VALUE >
VALUE& fc_order_small_map< KEY, VALUE, CONTAINTER_KEY, CONTAINTER_VALUE >::operator[](const KEY& key)
{
...
template< typename KEY, typename VALUE, typename CONTAINTER_KEY, typename CONTAINTER_VALUE >
typename fc_order_small_map< KEY, VALUE, CONTAINTER_KEY, CONTAINTER_VALUE >::iterator
fc_order_small_map< KEY, VALUE, CONTAINTER_KEY, CONTAINTER_VALUE >::erase(iterator it)
{
...
template< typename KEY, typename VALUE, typename CONTAINTER_KEY, typename CONTAINTER_VALUE >
typename fc_order_small_map< KEY, VALUE, CONTAINTER_KEY, CONTAINTER_VALUE >::iterator
fc_order_small_map< KEY, VALUE, CONTAINTER_KEY, CONTAINTER_VALUE >::find(const KEY& key)
{
	iterator i       = begin();
...
template< typename KEY, typename VALUE, typename CONTAINTER_KEY, typename CONTAINTER_VALUE >
typename fc_order_small_map< KEY, VALUE, CONTAINTER_KEY, CONTAINTER_VALUE >::const_iterator
fc_order_small_map< KEY, VALUE, CONTAINTER_KEY, CONTAINTER_VALUE >::find(const KEY& key) const
{
...
template< typename KEY, typename VALUE, typename CONTAINTER_KEY, typename CONTAINTER_VALUE >
const VALUE fc_order_small_map< KEY, VALUE, CONTAINTER_KEY, CONTAINTER_VALUE >::value(const KEY& key,
...
#ifdef QT_VERSION
template< typename KEY, typename VALUE, typename CONTAINTER_KEY, typename CONTAINTER_VALUE >
QMap< KEY, VALUE > fc_order_small_map< KEY, VALUE, CONTAINTER_KEY, CONTAINTER_VALUE >::toMap() const
{
	QMap< KEY, VALUE > r;
	int s = size();
